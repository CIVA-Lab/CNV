...
%        
%  Outputs: Images ready to be classified in Classify_me_circles.m
%        
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% 
...
%
% addpath '.\Matlab_code';
inputpath='.\stage_test\';  %%The data here were the input to max rcnn 
inputpath_maskresults='.\Output_from_MaskRCNN_masks\';
folders = dir(inputpath);

outputpath='.\Classify_me_circles\';
if (~isdir(outputpath))
 mkdir(outputpath);
end
